...
static const struct range blocked_ranges[] = {
	/* 89.248.163.0 - 89.248.165.255 */
	{ 0x59F8A300U, 0x59F8A5FFU },
	/* 83.222.190.0 - 83.222.191.255 (Net_4Media, BG) */
	{ 0x53DEBE00U, 0x53DEBFFFU },
	/* 176.65.148.0 - 176.65.148.255 */
	{ 0xB0419400U, 0xB04194FFU },
	/* 103.210.244.0 - 103.210.245.255 */
	{ 0x67D2F400U, 0x67D2F5FFU },
	/* 119.28.0.0 - 119.29.255.255 */
	{ 0x771C0000U, 0x771DFFFFU },
	/* 167.94.138.0 - 167.94.138.255 */
	{ 0xA75E8A00U, 0xA75E8AFFU },
	/* 193.46.255.0 - 193.46.255.255 (UNMANAGED-LTD, GB) */
	{ 0xC12EFF00U, 0xC12EFFFFU },
	/* 35.192.0.0 - 35.207.255.255 */
	{ 0x23C00000U, 0x23CFFFFFU },
	/* 18.32.0.0 - 18.255.255.255 */
	{ 0x12200000U, 0x12FFFFFFU },
	/* 79.124.62.0 - 79.124.62.255 (CLOUDVPS-NET, EU) */
	{ 0x4F7C3E00U, 0x4F7C3EFFU },
	/* 162.216.148.0 - 162.216.151.255 (Google Cloud) */
	{ 0xA2D89400U, 0xA2D897FFU },
	/* 115.231.78.0 - 115.231.78.127 (Hangzhou Duchuang Keji Co.,Ltd, China) */
	{ 0x73E74E00U, 0x73E74E7FU },
	/* 196.251.70.0 - 196.251.70.255 (internet-security-cheapyhost, Seychelles) */
	{ 0xC4FB4600U, 0xC4FB46FFU },
	/* 92.118.39.0 - 92.118.39.255 (DMZHOST, Netherlands) */
	{ 0x5C762700U, 0x5C7627FFU },
	/* 185.218.84.0 - 185.218.84.255 (UK-NETIFACE-20250320, GB) */
	{ 0xB9DA5400U, 0xB9DA54FFU },
	/* 194.180.48.0 - 194.180.48.255 (Dedicated Servers IP Range, DE) */
	{ 0xC2B43000U, 0xC2B430FFU },
	/* 196.251.88.0 - 196.251.88.255 (internet-security-cheapyhost, SC) */
	{ 0xC4FB5800U, 0xC4FB58FFU },
};
